---
title: 线程和进程：基本介绍
description: 线程和进程：基本介绍。基本介绍 1.进程：可以理解为：你运行一个python程序，最终“进程已结束，退出代码 0”， 就是该python程序所有的内容执行完毕。 2.主线程：应用程序运行即为主线程（从程序第一行…适合日常查阅、复习对照与工程检索。含命令、参数与常见踩坑提示。便于按需检索与落地对照。
date: 2023-01-26T21:57:12.000Z
tags: null
abbrlink: b3a6abb4
