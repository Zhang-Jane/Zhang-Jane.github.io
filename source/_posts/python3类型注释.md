---
title: Python3类型注释：学习笔记与要点整理
description: Python3类型注释：学习笔记与要点整理。普通的注释 - 在声明变量类型时，变量后方紧跟一个冒号，冒号后面跟一个空格，再跟上变量的类型。 - 在声明方法返回值的时候，箭头左边是方法定义，箭头右边是返回值的类型，箭头左右两边都要留有…适合日常查阅、复习对照与工程检索。含命令、参数与常见踩坑提示。
date: 2021-04-20T17:54:18.000Z
tags: python3
categories: python3
abbrlink: f19d1117
