...
description: 前端是什么：我们每天都在上网，我们上网上的是什么？最简单的就是看图片、视频、文字，这些在计算机中统称为超文本（Hypertext）。适合日常查阅、复习对照与工程检索。含命令、参数与常见踩坑提示。便于按需检索与落地对照。本笔记整理要点、命令与常见踩坑，适合日常查阅、复习对照与工程落地时快速检索。
