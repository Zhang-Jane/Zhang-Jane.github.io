---
title: Django的DRF：前后端分离
description: Django的DRF：前后端分离。前后端分离 - Django是很大很全，可以做到前端后端全包，提供了很棒的模版技术，orm操作。但是后来发现这样并不好，前端应该只是来绘制页面，后端只负责数据的部分，二者互不干扰，并行开发…适合日常查阅、复习对照与工程检索。含命令、参数与常见踩坑提示。
date: 2021-05-11T17:12:41.000Z
tags: django
categories: django
abbrlink: 7dc334fa
