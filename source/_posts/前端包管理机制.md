...
categories: 前端
description: >-
  npm、Yarn、pnpm、Yarn Berry（PnP）与 Bun 怎样影响 node_modules？从 Hoisting、幻影依赖到内容寻址与 PnP，对照锁文件、磁盘与速度，并说明新仓库选型与迁移成本。附对比表与命令片段；可与本站 Python 依赖笔记、Actions 部署 Hexo、全栈选型文交叉阅读。
abbrlink: bacdc374
