...
description: py面向对象特性：继承、封装、多态、鸭子模型、魔法方法。继承的重点 1、子类拥有父类非私有化的属性和方法。 2、子类可以拥有自己属性和方法，即子类可以对父类进行扩展。 3、子类可以用自己的方式实现父类的方法。（重写）。 单继承 python c…适合日常查阅、复习对照与工程检索。
date: 2022-12-16T19:53:04.000Z
tags: python3
categories: python3
abbrlink: "10770794"
