---
title: 日常使用的工具：mycli(python)
description: 日常使用的工具：mycli(python)。数据库 mycli(python) github:https://github.com/dbcli/mycli A command line client for MySQL that c…适合日常查阅、复习对照与工程检索。含命令、参数与常见踩坑提示。
date: 2023-02-05T15:39:33.000Z
tags: 工具箱
categories: 工具箱
abbrlink: "897196e0"
