---
title: 什么是爬虫：什么是爬虫？
description: 什么是爬虫：什么是爬虫？。什么是爬虫？ 百度说： 网络爬虫，是一种按照一定的规则，自动地抓取万维网信息的程序或者脚本。 某书上说： 它是指自动的连接到互联网站点，读取网页中的内容或者存放在网络上的各种信息，并按照某…适合日常查阅、复习对照与工程检索。含命令、参数与常见踩坑提示。便于按需检索与落地对照。
date: 2020-10-10T17:16:28.000Z
tags: python，爬虫
categories: 爬虫
cover: https://s2.best-wallpaper.net/wallpaper/1920x1200/1510/Insect-spider-web-green-leaves-water-drops_1920x1200.jpg
abbrlink: c3d01f49
