---
title: Xposed的hook：Xposed 的原理
description: Xposed的hook：Xposed 的原理。Xposed 的原理 Android基于Linux，第一个启动的进程自然是init进程，该进程会启动所有Android进程的父进程——Zygote(孵化)进程，该进程的启动配置在/init…适合日常查阅、复习对照与工程检索。含命令、参数与常见踩坑提示。
date: 2020-10-28T20:31:40.000Z
tags: hook
categories: hook
abbrlink: ec4e79f7
