---
title: 远程连接服务器的一些配置：学习笔记与要点整理
description: "远程连接服务器的一些配置：学习笔记与要点整理。ssh免密连接 服务器： 生成秘钥: 执行下面命令,默认生成位置是~/.ssh bash ssh-keygen ssh-keygen -t rsa -C \"youremail@exampl…适合日常查阅、复习对照与工程检索。含命令、参数与常见踩坑提示。"
date: 2020-11-22T17:33:02.000Z
abbrlink: eb9d357a
