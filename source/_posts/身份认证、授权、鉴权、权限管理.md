---
title: 身份认证、授权、鉴权、权限管理：认证(identification)
description: 身份认证、授权、鉴权、权限管理：认证(identification)。认证(identification) 确认声明者的身份 根据声明者独特的识别信息 授权(authorization) 获取用户的委派权限 颁发一个授信媒介，不可被篡改，不可伪造，受保护 -…适合日常查阅、复习对照与工程检索。
date: 2022-12-21T17:55:57.000Z
tags: null
abbrlink: 5c1d7fbd
