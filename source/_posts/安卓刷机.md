---
title: Android刷机教程：权限
description: Android刷机教程：权限。刷机相关的词汇解释 权限 - 第三方软件权限（低） - 比如，每次app启动都会向用户请求读取信息，当然流氓软件你不同意，APP直接不让你启动 - 用户权限（中） - 基本的增删改查，安装…适合日常查阅、复习对照与工程检索。含命令、参数与常见踩坑提示。
date: 2020-11-08T21:37:52.000Z
tags: android刷机
categories: 刷机
abbrlink: "574e8458"
